...
- **Window Managers**: Aerospace and OmniWM tiling window manager configurations
...
bash window_managers/aerospace/setup.sh # Aerospace window manager
bash window_managers/omniwm/setup.sh    # OmniWM window manager
